...
myObject.someMethod(); //Value Of This is undefined
...
// Output
obj.getThis.call(a); // Windows

// Output
obj.getThis2(); // Object

// Output
obj.getThis2.call(a); // object {a: `a`}
...
console.log(person.print()); // Jai Details and Jai Persons.
...
// ----------- Error interterm is not defined
...
let object = {
  ...
  double: function () {
    ...
    return this.data.map(function (item) {
      console.log(this); // this inside of outerFn doubleArrow() ???
      return item * 2;
    });
  },
...
console.log(getSecondData()); // 2 and  ???
...
newCall(); // Hey undefined is called

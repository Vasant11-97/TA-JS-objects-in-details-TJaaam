...
console.log(user.sayHello()); // Hello John / Because user function is called

console.log(user2.sayHello()); // Hello Arya / Because user2 function is called

console.log(user.sayHello.call(user2)); // Hello Arya

console.log(user.sayHello.call(user2, 'Hey')); // Hey Arya because hello is replaced by hey in the function call

console.log(user.sayHello.apply(user2, ['Hey'])); // Hey Arya because hello is replaced by hey in the function call

console.log(typeof user.sayHello.bind(user2)); // function we wanted to know the typeOf of user2

console.log(user.sayHello.bind(user2)()); // Hello Arya 

console.log(userSayHello()); // hello undefined

console.log(typeof userSayHello.bind(user2)); // function because we wanted to know the typeOf of user2

console.log(userSayHello.bind(user2)()); // Hello Arya

console.log(user3.sayHello()); // error because user3.sayHello is not a function
